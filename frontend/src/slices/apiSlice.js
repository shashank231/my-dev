// This file is parent to our other API Slices 
// fetchBaseQuery - function that allow us to make req to our backend api
...
export const apiSlice = createApi({
  ...
  tagTypes: ['Product', 'Order', 'User'],  // tag type used to define kind of data we would be fetching from our api
  endpoints: (builder) => ({}),
});
